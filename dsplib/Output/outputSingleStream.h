/*******************************************************************************
 * ManyEars: OutputSingleStream - Header                                       *
 * --------------------------------------------------------------------------- *
 *                                                                             *
...
#ifndef OUTPUTSINGLESTREAM_H
#define OUTPUTSINGLESTREAM_H
 ...
 ******************************************************************************/
    ...
    #define      OUTPUTSINGLESTREAM_NOSOURCE              -1

/*******************************************************************************
 * Structure                                                                   *
 ******************************************************************************/

struct objOutputSingleStream
{
    ...
    // Path of the file name for the stream
    char* pathStreamWave;
    char* pathStreamData;
    ...
    // File pointer
    FILE* pointerStreamWave;
    FILE* pointerStreamData;

    // Temporary array
    float* tmpArray;

    // Watermark arrays
    signed short* noWatermarkArray;
    signed short* watermarkArray;

    // Watermark elements
    float* watermarkElementsArray;
