...
/*
			for(k=0;k<myRij->RIJ_FRAMESIZE;k++)
			{
				printf("%f ",myRij->workingArray1Real[k]);
			}
			printf("\n");
			printf("\n");
			for(k=0;k<myRij->RIJ_FRAMESIZE;k++)
			{
				printf("%f ",myRij->workingArray1Imag[k]);
			}
			printf("\n");
			printf("\n");
			for(k=0;k<myRij->RIJ_FRAMESIZE;k++)
			{
				printf("%f ",myRij->crossCorr[indexPair-1][k]);
			}
			printf("\n");
			printf("\n");
			for(k=0;k<myRij->RIJ_FRAMESIZE;k++)
			 {
				 printf("%f ",myRij->crossCorr[indexPair][k]);
			 }
			printf("\n");
			printf("\n");
...
/*
        ...
        ifftComputeOnce(myRij->myFFT, myRij->workingArray1Real, myRij->workingArray1Imag, myRij->crossCorr[indexPair]);
        printf(":%d         :",indexPair);
		for(k=0;k<myRij->RIJ_FRAMESIZE;k++)
		{
...
*/
    ...
    * Step 2: Filter the cross-correlation terms 
    find the max value in the range of filterRange
    ***************************************************************************/
